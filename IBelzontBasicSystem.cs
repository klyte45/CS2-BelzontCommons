...
{
    public interface IBelzontBasicSystem { }

    public abstract partial class BelzontBasicSystem : GameSystemBase, IBelzontBasicSystem
    {
        ...
        private void RegisterSystem()
        {
            ...
            LogUtils.DoInfoLog($"Registered system {GetType()} at {UpdatePhase}");
        }
